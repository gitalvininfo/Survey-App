                    ...
                    <li class="xn-profile">
                        ...
                        <div class="profile">
                            ...
                            <div class="profile-data">
                                <div class="profile-data-name">Alvin Yanson</div>
                                <div class="profile-data-title">Web Developer/Designer</div>
                            </div>
                        </div>                                                                        
                    </li>
                    <li>
                        <a href="home.php"><span class="fa fa-file-text"></span> <span class="xn-text">Survey</span></a>
                    </li>
                    <li>
                        <a href="survey_form.php"><span class="fa fa-pencil-square-o"></span> <span class="xn-text">Add Survey</span></a>
                    </li>
                    <li>
