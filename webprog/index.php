        ...
        <div class="login-container">
            ...
            <div class="login-box animated fadeInDown">
                <div class="login-body">
                    <div class="login-title"><strong>Welcome, </strong>login to your account</div>
                    <form action="index.html" class="form-horizontal" method="post">
                        ...
                        <div class="form-group">
                            <div class="col-md-6">
                                <a href="home.php" class="btn btn-link btn-block">Forgot your password?</a>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="login-subtitle">
                            Don't have an account yet? <a href="sign_up.php">Create an account</a>
                        </div>
                    </form>
                </div>
